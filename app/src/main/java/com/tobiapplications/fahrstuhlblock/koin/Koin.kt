...
import com.tobiapplications.fahrstuhlblock.core.entities.models.settings.GameRuleSettingsData
...
import com.tobiapplications.fahrstuhlblock.core.databaseroom.databaseModule
import com.tobiapplications.fahrstuhlblock.core.repositories.datasource.sharedpref.FahrstuhlBlockSharedPreferences
import com.tobiapplications.fahrstuhlblock.core.repositories.datasource.firebase.AnalyticsDatasourceImpl
import com.tobiapplications.fahrstuhlblock.core.repositories.processor.BlockInputsProcessorImpl
import com.tobiapplications.fahrstuhlblock.core.repositories.processor.BlockResultsProcessorImpl
import com.tobiapplications.fahrstuhlblock.core.repositories.repository.FirebaseRepositoryImpl
import com.tobiapplications.fahrstuhlblock.core.repositories.repository.GameRepositoryImpl
import com.tobiapplications.fahrstuhlblock.core.repositories.repository.UserRepositoryImpl
...
import com.tobiapplications.fahrstuhlblock.core.interactor.usecase.block.*
import com.tobiapplications.fahrstuhlblock.core.interactor.usecase.firebase.TrackAnalyticsEventUseCase
import com.tobiapplications.fahrstuhlblock.core.interactor.usecase.player.GetPlayerNamesUseCase
import com.tobiapplications.fahrstuhlblock.core.interactor.usecase.player.StorePlayerNamesUseCase
import com.tobiapplications.fahrstuhlblock.core.interactor.usecase.savedgames.GetAllSavedGamesUseCase
import com.tobiapplications.fahrstuhlblock.core.interactor.usecase.savedgames.DeleteSavedGameUseCase
import com.tobiapplications.fahrstuhlblock.core.interactor.usecase.settings.GetLastSettingsUseCase
...
import com.tobiapplications.fahrstuhlblock.core.presentation.settings.*
