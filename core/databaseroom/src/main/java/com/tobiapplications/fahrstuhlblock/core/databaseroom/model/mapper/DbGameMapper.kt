package com.tobiapplications.fahrstuhlblock.core.databaseroom.model.mapper
...
import com.tobiapplications.fahrstuhlblock.core.databaseroom.model.classes.*
...
fun GameInfo.mapToDbData() = DbGameInfo(
    ...
    stopElevatorAtHighCard = stopElevatorAtHighCard,
    firstRoundTipsCanBeOne = firstRoundTipsCanBeOne,
