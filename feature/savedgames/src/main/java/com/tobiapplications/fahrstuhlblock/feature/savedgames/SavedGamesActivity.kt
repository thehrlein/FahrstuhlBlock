...
import com.tobiapplications.fahrstuhlblock.feature.savedgames.databinding.ActivitySavedGamesBinding
...
class SavedGamesActivity : BaseToolbarActivity<SavedGamesViewModel, ActivitySavedGamesBinding>() {
    ...
    override val toolbarTitle: String?
        get() = getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.saved_game_toolbar_title)
