...
import com.tobiapplications.fahrstuhlblock.feature.common.bindings.setVisible
import com.tobiapplications.fahrstuhlblock.feature.gamesettings.R
import com.tobiapplications.fahrstuhlblock.feature.gamesettings.databinding.WidgetPlayerNameInputBinding
...
class PlayerNameInputView @JvmOverloads constructor(
    ...
    fun setAdapter(items: Set<String>) {
        binding.autoCompleteText.setAdapter(
            ArrayAdapter(
                context,
                com.tobiapplications.fahrstuhlblock.feature.common.R.layout.item_auto_complete_text_row,
                items.toList()
            )
        )
    }
