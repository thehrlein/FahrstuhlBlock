package com.tobiapplications.fahrstuhlblock.feature.gamesettings.pointrules
...
class PointRulesFragment :
    ...
    override fun onBindingCreated(savedInstanceState: Bundle?) {
        ...
        activityToolbarViewModel.setTitle(getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.point_rules_toolbar_title))
    }
