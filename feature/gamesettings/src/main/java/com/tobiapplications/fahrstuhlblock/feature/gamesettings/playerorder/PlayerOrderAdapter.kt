...
import com.tobiapplications.fahrstuhlblock.feature.gamesettings.databinding.ItemPlayerRowBinding
    ...
    inner class PlayerOrderViewHolder(private val binding: ItemPlayerRowBinding) :
        ...
        fun bind(item: String, onItemTouchListener: ((RecyclerView.ViewHolder) -> Unit)?) {
            ...
            binding.playerPosition.text =
                binding.root.context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.player_order_position, adapterPosition + 1)
