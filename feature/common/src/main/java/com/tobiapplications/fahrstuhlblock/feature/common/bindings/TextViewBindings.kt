...
fun TextView.setInputTitle(game: Game?) {
    ...
    text = context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_input_general_title, game.currentRoundNumber, game.currentCardCount)
}
...
fun TextView.setInputMessage(inputType: InputType?, game: Game?) {
    ...
    text = when (inputType) {
        InputType.TIPP -> context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_input_tipps_message, game.currentCardCount)
        InputType.RESULT -> context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_input_result_message, game.currentCardCount)
    }
}
...
fun TextView.setPosition(pos: Int?) {
    if (pos == null) return
    text = context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_scores_position, pos)
}
...
fun TextView.setTotalRounds(totalRounds: Int?) {
    ...
    text = context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.game_rules_total_rounds, totalRounds)
}
