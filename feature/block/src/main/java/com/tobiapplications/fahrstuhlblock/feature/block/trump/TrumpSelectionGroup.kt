package com.tobiapplications.fahrstuhlblock.feature.block.trump
...
import com.tobiapplications.fahrstuhlblock.feature.block.databinding.WidgetTrumpSelectionGroupBinding
...
class TrumpSelectionGroup @JvmOverloads constructor(
    ...
    private fun setItems() {
        ...
        binding.groupOne.addView(TrumpSelectionItem(context).apply {
            setItem(Trump(context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_trump_type_clubs), TrumpType.CLUB)) {
                setTrumpSelected(it)
            }
        }.also {
        ...
        binding.groupOne.addView(TrumpSelectionItem(context).apply {
            setItem(Trump(context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_trump_type_spades), TrumpType.SPADE)) {
                setTrumpSelected(it)
            }
        }.also {
        ...
        binding.groupTwo.addView(TrumpSelectionItem(context).apply {
            setItem(Trump(context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_trump_type_hearts), TrumpType.HEART)) {
                setTrumpSelected(it)
            }
        }.also {
        ...
        binding.groupTwo.addView(TrumpSelectionItem(context).apply {
            setItem(
                Trump(
                    context.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_trump_type_diamonds),
                    TrumpType.DIAMOND
                )
            ) {
                setTrumpSelected(it)
