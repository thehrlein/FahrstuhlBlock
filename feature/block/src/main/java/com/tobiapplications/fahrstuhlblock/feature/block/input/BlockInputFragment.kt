package com.tobiapplications.fahrstuhlblock.feature.block.input
...
import com.tobiapplications.fahrstuhlblock.feature.block.databinding.FragmentBlockInputBinding
import com.tobiapplications.fahrstuhlblock.feature.common.base.fragment.BaseToolbarFragment
import com.tobiapplications.fahrstuhlblock.feature.common.extension.getColorReference
...
class BlockInputFragment :
    ...
    override fun onBindingCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.inputType.observe(viewLifecycleOwner, Observer {
            activityToolbarViewModel.setTitle(
                getString(
                    when (it) {
                        InputType.TIPP -> com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_input_toolbar_title_tipps
                        InputType.RESULT -> com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_input_toolbar_title_results
    ...
    private fun setToolbarTrumpIcon(trumpType: TrumpType?): Pair<Drawable?, String>? {
        return context?.let {
            when (trumpType) {
                TrumpType.CLUB -> {
                    Pair(it.getDrawable(com.tobiapplications.fahrstuhlblock.feature.common.R.drawable.ic_card_club)?.apply {
                        setTintList(ColorStateList.valueOf(it.getColorReference(com.google.android.material.R.attr.colorOnPrimary)))
                    }, it.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_trump_type_clubs))
                }
                TrumpType.SPADE -> {
                    Pair(it.getDrawable(com.tobiapplications.fahrstuhlblock.feature.common.R.drawable.ic_card_spade)?.apply {
                        setTintList(ColorStateList.valueOf(it.getColorReference(com.google.android.material.R.attr.colorOnPrimary)))
                    }, it.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_trump_type_spades))
                }
                TrumpType.HEART -> {
                    Pair(it.getDrawable(com.tobiapplications.fahrstuhlblock.feature.common.R.drawable.ic_card_heart)?.apply {
                        setTintList(ColorStateList.valueOf(ContextCompat.getColor(it, com.tobiapplications.fahrstuhlblock.feature.common.R.color.color_card_red)))
                    }, it.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_trump_type_hearts))
                }
                TrumpType.DIAMOND -> {
                    Pair(it.getDrawable(com.tobiapplications.fahrstuhlblock.feature.common.R.drawable.ic_card_diamond)?.apply {
                        setTintList(ColorStateList.valueOf(ContextCompat.getColor(it, com.tobiapplications.fahrstuhlblock.feature.common.R.color.color_card_red)))
                    }, it.getString(com.tobiapplications.fahrstuhlblock.feature.common.R.string.block_trump_type_diamonds))
                }
                else -> null
            }
        }
